...
bool overlap(const rectangle& r1, const rectangle& r2){
    // if(r1.origin.x != r2.origin.x || r1.origin.y != r2.origin.y || r1.origin.x != r1.origin.y || r2.origin.x != r2.origin.y){
    //     return true;
    // }

    if((r1.origin.x < r2.origin.x && r2.origin.x < r1.origin.x + r1.width) && (r2.origin.y < r1.origin.y + r1.height)){
        return true;
    }

    if((r1.origin.x < r2.origin.x + r2.width) && (r1.origin.y < r2.origin.y + r2.height)){
        return true;
    }
